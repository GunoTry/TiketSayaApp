...
public class TicketCheckoutAct extends AppCompatActivity {
    ...
    //generate nomer integer secara random
    //karana kita ingin membuat transaksi secara unik
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoback = new Intent(TicketCheckoutAct.this, HomeAct.class);
        ...
        btn_buy_ticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reference3 = FirebaseDatabase.getInstance().getReference().child("MyTickets")
                        .child(username_key_new).child(nama_wisata.getText().toString() + nomer_transaksi);
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        reference3.getRef().child("id_ticket").setValue(nama_wisata.getText().toString()+ nomer_transaksi);
                        ...
                        Intent gosuccessticket= new Intent(TicketCheckoutAct.this, SuccessBuyTicketAct.class);
                        startActivity(gosuccessticket);
                    }
