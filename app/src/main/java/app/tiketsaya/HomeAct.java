...
public class HomeAct extends AppCompatActivity {
    ...
    ImageView photo_home_user, ketparis, ketpisa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ketparis = findViewById(R.id.ketparis);
        ketpisa = findViewById(R.id.ketpisa);
        ...
        btn_ticket_pagoda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gopisaticket = new Intent(HomeAct.this, TicketDetailAct.class);
                gopisaticket.putExtra("jenis_tiket", "Pagoda");
                startActivity(gopisaticket);
            }
        });
        btn_ticket_candi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gopisaticket = new Intent(HomeAct.this, TicketDetailAct.class);
                gopisaticket.putExtra("jenis_tiket", "Candi");
                startActivity(gopisaticket);
            }
        });
        btn_ticket_sphinx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gopisaticket = new Intent(HomeAct.this, TicketDetailAct.class);
                gopisaticket.putExtra("jenis_tiket", "Sphinx");
                startActivity(gopisaticket);
            }
        });
        btn_ticket_monas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gopisaticket = new Intent(HomeAct.this, TicketDetailAct.class);
                gopisaticket.putExtra("jenis_tiket", "Monas");
                startActivity(gopisaticket);
            }
        });
        ketparis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gogetparis = new Intent(HomeAct.this, KetParis.class);
                startActivity(gogetparis);
            }
        });

        ketpisa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gogetpisa = new Intent(HomeAct.this, KetParis.class);
                startActivity(gogetpisa);
            }
        });
    }
